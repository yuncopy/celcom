...
var CKFinder = function() {
    ...
    var basePath = function() {
        ...
        Modal = {
            open: function(e) {
                ...
                function o(e) {
                    var t, i, r = n(e);
                    f ? (t = l - (T - r.x), i = d - (I - r.y), t > 200 && (E.style.width = t + "px"), i > 200 && (E.style.height = i + "px")) : h && (t = l + (T - r.x), i = d - (I - r.y), t > 200 && (E.style.width = t + "px", y.style.left = F - (T - r.x) + "px"), i > 200 && (E.style.height = i + "px"))
                }

                function s() {
                    S.parentNode === E && E.removeChild(S), f = !1, h = !1, i(document, ["mousemove", "touchmove"], o), i(document, ["mouseup", "touchend"], s)
                }

                function a(e) {
                    e.preventDefault();
                    var i = n(e);
                    T = i.x, I = i.y, l = E.clientWidth, d = E.clientHeight, E.appendChild(S), t(document, ["mousemove", "touchmove"], o), t(document, ["mouseup", "touchend"], s)
                }
                if (e = e || {}, !Modal.div) {
                    Modal.heightAdded = 48, Modal.widthAdded = 2;
                    var l, d, u = Math.min(configOrDefault(e.width, 1e3), window.innerWidth - Modal.widthAdded),
                        c = Math.min(configOrDefault(e.height, 700), window.innerHeight - Modal.heightAdded),
                        f = !1,
                        h = !1,
                        g = !1,
                        p = 0,
                    ...
                    var C = Modal.header = document.getElementById("ckf-modal-header"),
                        F = y.offsetLeft,
                        x = y.offsetTop;
                    t(C, ["mousedown", "touchstart"], function(e) {
                        e.preventDefault(), g = !0;
                        var i = n(e);
                        p = i.x, m = i.y, F = p - y.offsetLeft, x = m - y.offsetTop, E.appendChild(S), t(document, ["mousemove", "touchmove"], r)
                    }), t(C, ["mouseup", "touchend"], function() {
                        g = !1, S.parentNode === E && E.removeChild(S), i(document, ["mousemove", "touchmove"], r)
                    });
                    var k = document.getElementById("ckf-modal-resize-handle-se"),
                        M = document.getElementById("ckf-modal-resize-handle-sw"),
                        E = Modal.body = document.getElementById("ckf-modal-body"),
                        S = document.createElement("div");
                    S.style.position = "absolute", S.style.top = S.style.right = S.style.bottom = S.style.left = 0, S.style.zIndex = 1e5, t(k, ["mousedown", "touchstart"], function(e) {
                        f = !0, a(e)
    ...
    return {
        ...
        popup: function(e) {
            ...
            var t = isIE9() ? window.CKFinder.basePath + "ckfinder.html" : "about:blank",
        ...
        _setup: function(window, document) {
            ...
            ! function() {
                if (!CKFinder || !CKFinder.requirejs) {
                    ...
                    ! function(global) {
                        ...
                        function newContext(e) {
                            ...
                            function i(e, i, n) {
                                var r, o, s, a, l, d, u, c, f, h, g, p, m = i && i.split("/"),
                                    v = x.map,
                                    w = v && v["*"];
                                if (e && (e = e.split("/"), u = e.length - 1, x.nodeIdCompat && jsSuffixRegExp.test(e[u]) && (e[u] = e[u].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && m && (p = m.slice(0, m.length - 1), e = p.concat(e)), t(e), e = e.join("/")), n && v && (m || w)) {
                                    ...
                                    e: for (a = s.length; a > 0; a -= 1) {
                                        if (d = s.slice(0, a).join("/"), m)
                                            for (l = m.length; l > 0; l -= 1)
                                                if (o = getOwn(v, m.slice(0, l).join("/")), o && (o = getOwn(o, d))) {
                                                    c = o, f = a;
                                                    break e
                            ...
                            function s(e, t, n, r) {
                                var s, a, l, d, u = null,
                                    ...
                                    h = !0,
                                    g = "";
                                return e || (h = !1, e = "_@r" + (_ += 1)), d = o(e), u = d[0], e = d[1], u && (u = i(u, c, r), a = getOwn(T, u)), e && (u ? g = a && a.normalize ? a.normalize(e, function(e) {
                                    return i(e, c, r)
                            ...
                            function l(e, t, i) {
                                var n = e.id,
                                    r = getOwn(k, n);
                                !hasProp(T, n) || r && !r.defineEmitComplete ? (r = a(e), r.error && "error" === t ? i(r.error) : r.on(t, i)) : "defined" === t && i(T[n])
                            }
                            ...
                            function f(e, t, i) {
                                ...
                                e.error ? e.emit("error", e.error) : (t[n] = !0, each(e.depMaps, function(n, r) {
                                    var o = n.id,
                                        s = getOwn(k, o);
                                    !s || e.depMatched[r] || i[o] || (getOwn(t, o) ? (e.defineDep(r, T[o]), e.check()) : f(s, t, i))
                                }), i[n] = !0)
                            }

                            function h() {
                                var e, t, i = 1e3 * x.waitSeconds,
                                    o = i && b.startTime + i < (new Date).getTime(),
                                    s = [],
                                    a = [],
                                    l = !1,
                                    u = !0;
                                if (!w) {
                                    if (w = !0, eachProp(M, function(e) {
                                            var i = e.map,
                                                d = i.id;
                                            if (e.enabled && (i.isDefine || a.push(e), !e.error))
                                                if (!e.inited && o) r(d) ? (t = !0, l = !0) : (s.push(d), n(d));
                            ...
                            return C = {
                                ...
                                load: function() {
                                    var e = this.map.url;
                                    I[e] || (I[e] = !0, b.load(this.map.id, e))
                                },
                                check: function() {
                                        ...
                                        if (this.inited) {
                                            if (this.error) this.emit("error", this.error);
                                                ...
                                                if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                                    ...
                                                    this.exports = r, this.map.isDefine && !this.ignore && (T[i] = r, req.onResourceLoad && req.onResourceLoad(b, this.map, this.depMaps)), c(i), this.defined = !0
                                                }
                                ...
                                callPlugin: function() {
                                    ...
                                    this.depMaps.push(n), l(n, "defined", bind(this, function(n) {
                                        var r, o, u, f = getOwn(K, this.map.id),
                                            h = this.map.name,
                                            g = this.map.parentMap ? this.map.parentMap.name : null,
                                            p = b.makeRequire(e.parentMap, {
                                                enableBuildCallback: !0
                                            });
                                ...
                                configure: function(e) {
                                    ...
                                    eachProp(e, function(e, t) {
                                        ...
                                        isArray(e) && (e = {
                                            deps: e
                                        }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = b.makeShimExports(e)), t[i] = e
                                    }), x.shim = t), e.packages && each(e.packages, function(e) {
                                        var t, i;
                                        e = "string" == typeof e ? {
                                            name: e
                                        } : e, i = e.name, t = e.location, t && (x.paths[i] = e.location), x.pkgs[i] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "")
                                ...
                                makeRequire: function(t, r) {
                                    function o(i, n, l) {
                                        var u, c, f;
                                        return r.enableBuildCallback && n && isFunction(n) && (n.__requireJsBuild = !0), "string" == typeof i ? isFunction(n) ? d(makeError("requireargs", "Invalid require call"), l) : t && hasProp(C, i) ? C[i](k[t.id]) : req.get ? req.get(b, i, t, o) : (c = s(i, t, !1, !0), u = c.id, hasProp(T, u) ? T[u] : d(makeError("notloaded", 'Module name "' + u + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(), b.nextTick(function() {
                                            v(), f = a(s(null, t)), f.skipMap = r.skipMap, f.init(i, n, l, {
                                                enabled: !0
                                            }), h()
                                        }), o)
                                    }
                                    return r = r || {}, mixin(o, {
                                        ...
                                        var i = s(e, t, !0),
                                            r = getOwn(k, e);
                                        r.undefed = !0, n(e), delete T[e], delete I[i.url], delete E[e], eachReverse(S, function(t, i) {
                                            t[0] === e && S.splice(i, 1)
                                ...
                                completeLoad: function(e) {
                                    ...
                                    if (n = getOwn(k, e), !t && !hasProp(T, e) && n && !n.inited) {
                                ...
                                nameToUrl: function(e, t, i) {
                                    ...
                                    if (u && (e = u), d = getOwn(K, e)) return b.nameToUrl(d, t, i);
                                    if (req.jsExtRegExp.test(e)) a = e + (t || "");
                                    else {
                                        for (n = x.paths, r = e.split("/"), o = r.length; o > 0; o -= 1)
                ...
                function() {
                    function e(e, t, i) {
                        for (var n = (i || 0) - 1, r = e ? e.length : 0; ++n < r;)
                            if (e[n] === t) return n;
                        return -1
                    }
                    ...
                    function f(i) {
                        function g(e) {
                            return e && "object" == typeof e && !Zn(e) && Rn.call(e, "__wrapped__") ? e : new p(e)
                        }
                        ...
                        function W(e, t, i, n, r) {
                            ...
                            return f && (Rn.call(e, "index") && (o.index = e.index), Rn.call(e, "input") && (o.input = e.input)), t ? (n.push(e), r.push(o), (f ? Jt : lr)(e, function(e, s) {
                                o[s] = W(e, t, i, n, r)
                            }), h && (d(n), d(r)), o) : o
                        }
                        ...
                        function J(e, t, i) {
                            if ("function" != typeof e) return Yi;
                            if ("undefined" == typeof t || !("prototype" in e)) return e;
                            var n = e.__bindData__;
                            if ("undefined" == typeof n && (Jn.funcNames && (n = !e.name), n = n || !Jn.funcDecomp, !n)) {
                                var r = Vn.call(e);
                                Jn.funcNames || (n = !E.test(r)), n || (n = K.test(r), Yn(e, n))
                            }
                        ...
                        function Y(e) {
                            function t() {
                                ...
                                if (r) {
                                    var g = c(r);
                                    Dn.apply(g, arguments)
                                }
                                if ((o || u) && (g || (g = c(arguments)), o && Dn.apply(g, o), u && g.length < a)) return n |= 16, Y([i, f ? n : -4 & n, g, null, s, a]);
                        ...
                        function et(e, t, i, n) {
                            for (var r = (n || 0) - 1, o = e ? e.length : 0, s = []; ++r < o;) {
                                var a = e[r];
                                if (a && "object" == typeof a && "number" == typeof a.length && (Zn(a) || ft(a))) {
                                    t || (a = et(a, t, i));
                                    var l = -1,
                                        d = a.length,
                                        u = s.length;
                        ...
                        function tt(e, t, i, n, r, o) {
                            ...
                            var c = Sn.call(e),
                                f = Sn.call(t);
                            if (c == R && (c = O), f == R && (f = O), c != f) return !1;
                            switch (c) {
                                case z:
                                case P:
                                    return +e == +t;
                            ...
                            var h = c == D;
                            if (!h) {
                                var g = Rn.call(e, "__wrapped__"),
                                    p = Rn.call(t, "__wrapped__");
                                if (g || p) return tt(g ? e.__wrapped__ : e, p ? t.__wrapped__ : t, i, n, r, o);
                                if (c != O) return !1;
                                var m = e.constructor,
                                    v = t.constructor;
                                if (m != v && !(It(m) && m instanceof m && It(v) && v instanceof v) && "constructor" in e && "constructor" in t) return !1
                            }
                            var w = !r;
                            r || (r = a()), o || (o = a());
                            ...
                            if (s = !0, r.push(e), o.push(t), h) {
                                if (y = e.length, b = t.length, s = b == y, s || n)
                                    for (; b--;) {
                                        var C = y,
                                            F = t[b];
                                        if (n)
                                            for (; C-- && !(s = tt(e[C], F, i, n, r, o)););
                                        else if (!(s = tt(e[b], F, i, n, r, o))) break
                                    }
                            } else ar(t, function(t, a, l) {
                                return Rn.call(l, a) ? (b++, s = Rn.call(e, a) && tt(e[a], t, i, n, r, o)) : void 0
                            }), s && !n && ar(e, function(e, t, i) {
                                return Rn.call(i, t) ? s = --b > -1 : void 0
                            });
                            return r.pop(), o.pop(), w && (d(r), d(o)), s
                        }

                        function it(e, t, i, n, r) {
                            (Zn(t) ? Jt : lr)(t, function(t, o) {
                                var s, a, l = t,
                                    d = e[o];
                                if (t && ((a = Zn(t)) || dr(t))) {
                                    ...
                                    if (!s) {
                                        var c;
                                        i && (l = i(d, t), (c = "undefined" != typeof l) && (d = l)), c || (d = a ? Zn(d) ? d : [] : dr(d) ? d : {}), n.push(t), r.push(d), c || it(d, t, i, n, r)
                                    }
                        ...
                        function st(e, t, i, n, r, o) {
                            var s = 1 & t,
                                ...
                                d = 16 & t,
                                u = 32 & t;
                            if (!a && !It(e)) throw new xn;
                            d && !i.length && (t &= -17, d = i = !1), u && !n.length && (t &= -33, u = n = !1);
                            var f = e && e.__bindData__;
                            if (f && f !== !0) return f = c(f), f[2] && (f[2] = c(f[2])), f[3] && (f[3] = c(f[3])), !s || 1 & f[1] || (f[4] = r), !s && 1 & f[1] && (t |= 8), !l || 4 & f[1] || (f[5] = o), d && Dn.apply(f[2] || (f[2] = []), i), u && An.apply(f[3] || (f[3] = []), n), f[1] |= t, st.apply(null, f);
                            var h = 1 == t || 17 === t ? y : Y;
                        ...
                        function ut(e) {
                            var t, i;
                            return e && Sn.call(e) == O && (t = e.constructor, !It(t) || t instanceof t) ? (ar(e, function(e, t) {
                                i = t
                            }), "undefined" == typeof i || Rn.call(e, i)) : !1
                        }
                        ...
                        function ft(e) {
                            return e && "object" == typeof e && "number" == typeof e.length && Sn.call(e) == R || !1
                        }
                        ...
                        function mt(e, t, i) {
                            var n;
                            return t = g.createCallback(t, i, 3), lr(e, function(e, i, r) {
                        ...
                        function vt(e, t, i) {
                            var n;
                            return t = g.createCallback(t, i, 3), yt(e, function(e, i, r) {
                                return t(e, i, r) ? (n = i, !1) : void 0
                            }), n
                        }
                        ...
                        function Ct(e, t) {
                            return e ? Rn.call(e, t) : !1
                        }

                        function Ft(e) {
                            for (var t = -1, i = er(e), n = i.length, r = {}; ++t < n;) {
                                var o = i[t];
                                r[e[o]] = o
                            }
                            return r
                        ...
                        function xt(e) {
                            return e === !0 || e === !1 || e && "object" == typeof e && Sn.call(e) == z || !1
                        }

                        function kt(e) {
                            return e && "object" == typeof e && Sn.call(e) == P || !1
                        }
                        ...
                        function Et(e) {
                            ...
                            var i = Sn.call(e),
                                n = e.length;
                            return i == D || i == H || i == R || i == O && "number" == typeof n && It(e.splice) ? !n : (lr(e, function() {
                                return t = !1
                            }), t)
                        }

                        function St(e, t, i, n) {
                            return tt(e, t, "function" == typeof i && J(i, n, 2))
                        }

                        function Tt(e) {
                            return Hn(e) && !Nn(parseFloat(e))
                        }
                        ...
                        function Rt(e) {
                            return e && "object" == typeof e && Sn.call(e) == U || !1
                        }

                        function Dt(e) {
                            return "string" == typeof e || e && "object" == typeof e && Sn.call(e) == H || !1
                        }
                        ...
                        function At(e) {
                            var t = arguments,
                                i = 2;
                            if (!Kt(e)) return e;
                            if ("number" != typeof t[2] && (i = t.length), i > 3 && "function" == typeof t[i - 2]) var n = J(t[--i - 1], t[i--], 2);
                            else i > 2 && "function" == typeof t[i - 1] && (n = t[--i]);
                            for (var r = c(arguments, 1, i), o = -1, s = a(), l = a(); ++o < i;) it(e, r[o], n, s, l);
                            return d(s), d(l), e
                        }
                        ...
                        function Bt(e, t, i) {
                            ...
                            if ("function" != typeof t) {
                                ...
                                ar(e, function(e, t) {
                                    r.push(t)
                                }), r = Z(r, et(arguments, !0, !1, 1));
                                for (var o = -1, s = r.length; ++o < s;) {
                                    var a = r[o];
                                    n[a] = e[a]
                                }
                            } else t = g.createCallback(t, i, 3), ar(e, function(e, i, r) {
                                t(e, i, r) || (n[i] = e)
                            });
                            return n
                        }
                        ...
                        function Ot(e) {
                            for (var t = -1, i = er(e), n = i.length, r = gn(n); ++t < n;) {
                                var o = i[t];
                                r[t] = [o, e[o]]
                            }
                            return r
                        ...
                        function Ut(e, t, i) {
                            var n = {};
                            if ("function" != typeof t)
                                for (var r = -1, o = et(arguments, !0, !1, 1), s = Kt(e) ? o.length : 0; ++r < s;) {
                                    var a = o[r];
                                    a in e && (n[a] = e[a])
                                } else t = g.createCallback(t, i, 3), ar(e, function(e, i, r) {
                                    t(e, i, r) && (n[i] = e)
                        ...
                        function Ht(e, t, i, n) {
                            ...
                            return t && (t = g.createCallback(t, n, 4), (r ? Jt : lr)(e, function(e, n, r) {
                                return t(i, e, n, r)
                            })), i
                        }

                        function Nt(e) {
                            for (var t = -1, i = er(e), n = i.length, r = gn(n); ++t < n;) r[t] = e[i[t]];
                            return r
                        }

                        function jt(e) {
                            for (var t = arguments, i = -1, n = et(t, !0, !1, 1), r = t[2] && t[2][t[1]] === e ? 1 : n.length, o = gn(r); ++i < r;) o[i] = e[n[i]];
                            return o
                        }
                        ...
                        function Lt(e, t, i) {
                            var n = -1,
                                ...
                                o = e ? e.length : 0,
                                s = !1;
                            return i = (0 > i ? Ln(0, o + i) : i) || 0, Zn(e) ? s = r(e, t, i) > -1 : "number" == typeof o ? s = (Dt(e) ? e.indexOf(t, i) : r(e, t, i)) > -1 : lr(e, function(e) {
                        ...
                        function Jt(e, t, i) {
                            var n = -1,
                                r = e ? e.length : 0;
                            if (t = t && "undefined" == typeof i ? t : J(t, i, 3), "number" == typeof r)
                                for (; ++n < r && t(e[n], n, e) !== !1;);
                            else lr(e, t);
                            return e
                        }
                        ...
                        function Yt(e, t, i) {
                            var n = e ? e.length : 0;
                            if (t = t && "undefined" == typeof i ? t : J(t, i, 3), "number" == typeof n)
                                for (; n-- && t(e[n], n, e) !== !1;);
                            else {
                                var r = er(e);
                                n = r.length, lr(e, function(e, i, o) {
                        ...
                        function Qt(e, t, i) {
                            var n = -1,
                                r = e ? e.length : 0;
                            if (t = g.createCallback(t, i, 3), "number" == typeof r)
                                for (var o = gn(r); ++n < r;) o[n] = t(e[n], n, e);
                            else o = [], lr(e, function(e, i, r) {
                                o[++n] = t(e, i, r)
                            });
                            return o
                        }
                        ...
                        function ei(e, t, i) {
                            var r = -1 / 0,
                                o = r;
                            if ("function" != typeof t && i && i[t] === e && (t = null), null == t && Zn(e))
                                for (var s = -1, a = e.length; ++s < a;) {
                                    var l = e[s];
                                    l > o && (o = l)
                                } else t = null == t && Dt(e) ? n : g.createCallback(t, i, 3), Jt(e, function(e, i, n) {
                                    var s = t(e, i, n);
                                    s > r && (r = s, o = e)
                                });
                            return o
                        ...
                        function ni(e, t, i, n) {
                            var r = arguments.length < 3;
                            return t = g.createCallback(t, n, 4), Yt(e, function(e, n, o) {
                                i = r ? (r = !1, e) : t(i, e, n, o)
                            }), i
                        }

                        function ri(e, t, i) {
                            return t = g.createCallback(t, i, 3), Wt(e, function(e, i, n) {
                                return !t(e, i, n)
                            })
                        }

                        function oi(e, t, i) {
                            if (e && "number" != typeof e.length && (e = Nt(e)), null == t || i) return e ? e[nt(0, e.length - 1)] : h;
                            var n = si(e);
                            return n.length = $n(Ln(0, t), n.length), n
                        }

                        function si(e) {
                            var t = -1,
                                i = e ? e.length : 0,
                                n = gn("number" == typeof i ? i : 0);
                            return Jt(e, function(e) {
                                var i = nt(0, ++t);
                                n[t] = n[i], n[i] = e
                            }), n
                        ...
                        function di(e, t, i) {
                            var n = -1,
                                o = Zn(t),
                                s = e ? e.length : 0,
                                c = gn("number" == typeof s ? s : 0);
                            for (o || (t = g.createCallback(t, i, 3)), Jt(e, function(e, i, r) {
                                    var s = c[++n] = l();
                                    o ? s.criteria = Qt(t, function(t) {
                                        return e[t]
                        ...
                        function ui(e) {
                            return e && "number" == typeof e.length ? c(e) : Nt(e)
                        }
                        ...
                        function gi(e, t, i) {
                            var n = e ? e.length : 0;
                            for (t = g.createCallback(t, i, 3); n--;)
                                if (t(e[n], n, e)) return n;
                            return -1
                        }
                        ...
                        function pi(e, t, i) {
                            ...
                            return c(e, 0, $n(Ln(0, n), r))
                        }

                        function mi(e, t, i, n) {
                            return "boolean" != typeof t && null != t && (n = i, i = "function" != typeof t && n && n[t] === e ? null : t, t = !1), null != i && (e = Qt(e, i, n)), et(e, t)
                        }
                        ...
                        function wi(e, t, i) {
                            ...
                            return c(e, 0, $n(Ln(0, r - n), r))
                        }

                        function yi() {
                            for (var i = [], n = -1, r = arguments.length, s = a(), l = lt(), c = l === e, f = a(); ++n < r;) {
                                var h = arguments[n];
                                (Zn(h) || ft(h)) && (i.push(h), s.push(c && h.length >= w && o(n ? i[n] : f)))
                            }
                            var g = i[0],
                                p = -1,
                                m = g ? g.length : 0,
                            ...
                            e: for (; ++p < m;) {
                                ...
                                if (h = g[p], (y ? t(y, h) : l(f, h)) < 0) {
                                    for (n = r, (y || f).push(h); --n;)
                                        if (y = s[n], (y ? t(y, h) : l(i[n], h)) < 0) continue e;
                                    v.push(h)
                                }
                            }
                            for (; r--;) y = s[r], y && u(y);
                        ...
                        function Ci(e, t, i) {
                            var n = e ? e.length : 0;
                            for ("number" == typeof i && (n = (0 > i ? Ln(0, n + i) : $n(i, n - 1)) + 1); n--;)
                                if (e[n] === t) return n;
                            return -1
                        }

                        function Fi(e) {
                            for (var t = arguments, i = 0, n = t.length, r = e ? e.length : 0; ++i < n;)
                                for (var o = -1, s = t[i]; ++o < r;) e[o] === s && (Pn.call(e, o--, 1), r--);
                            return e
                        }

                        function xi(e, t, i) {
                            e = +e || 0, i = "number" == typeof i ? i : +i || 1, null == t && (t = e, e = 0);
                            for (var n = -1, r = Ln(0, In((t - e) / (i || 1))), o = gn(r); ++n < r;) o[n] = e, e += i;
                            return o
                        }
                        ...
                        function ki(e, t, i) {
                            ...
                            for (t = g.createCallback(t, i, 3); ++n < r;) {
                                var s = e[n];
                                t(s, n, e) && (o.push(s), Pn.call(e, n--, 1), r--)
                            }
                            return o
                        }
                        ...
                        function Ei(e, t, i, n) {
                            var r = 0,
                                o = e ? e.length : r;
                            for (i = i ? g.createCallback(i, n, 1) : Yi, t = i(t); o > r;) {
                                var s = r + o >>> 1;
                                i(e[s]) < t ? r = s + 1 : o = s
                            }
                            return r
                        ...
                        function Ti(e, t, i, n) {
                            return "boolean" != typeof t && null != t && (n = i, i = "function" != typeof t && n && n[t] === e ? null : t, t = !1), null != i && (i = g.createCallback(i, n, 3)), rt(e, t, i)
                        }
                        ...
                        function Ki() {
                            for (var e = -1, t = arguments.length; ++e < t;) {
                                var i = arguments[e];
                                if (Zn(i) || ft(i)) var n = n ? rt(Z(n, i).concat(Z(i, n))) : i
                            }
                            return n || []
                        }

                        function _i() {
                            for (var e = arguments.length > 1 ? arguments : arguments[0], t = -1, i = e ? ei(hr(e, "length")) : 0, n = gn(0 > i ? 0 : i); ++t < i;) n[t] = hr(e, t);
                            return n
                        }
                        ...
                        function Di(e) {
                            for (var t = arguments.length > 1 ? et(arguments, !0, !1, 1) : bt(e), i = -1, n = t.length; ++i < n;) {
                                var r = t[i];
                        ...
                        function Bi(e, t, i) {
                            var n, r, o, s, a, l, d, u = 0,
                                c = !1,
                                f = !0;
                            if (!It(e)) throw new xn;
                            if (t = Ln(0, t) || 0, i === !0) {
                                var g = !0;
                                f = !1
                            } else Kt(i) && (g = i.leading, c = "maxWait" in i && (Ln(t, i.maxWait) || 0), f = "trailing" in i ? i.trailing : f);
                            var p = function() {
                                    var i = t - (pr() - s);
                                    if (0 >= i) {
                                        r && Kn(r);
                                        var c = d;
                                        r = l = d = h, c && (u = pr(), o = e.apply(a, n), l || r || (n = a = null))
                                    } else l = zn(p, i)
                                },
                                m = function() {
                                    l && Kn(l), r = l = d = h, (f || c !== t) && (u = pr(), o = e.apply(a, n), l || r || (n = a = null))
                                };
                            return function() {
                                if (n = arguments, s = pr(), a = this, d = f && (l || !g), c === !1) var i = g && !l;
                                else {
                                    r || g || (u = s);
                                    var h = c - (s - u),
                                        v = 0 >= h;
                                    v ? (r && (r = Kn(r)), u = s, o = e.apply(a, n)) : r || (r = zn(m, h))
                                }
                                return v && l ? l = Kn(l) : l || t === c || (l = zn(p, t)), i && (v = !0, o = e.apply(a, n)), !v || l || r || (n = a = null), o
                            }
                        }
                        ...
                        function Hi(e, t) {
                            ...
                            var i = function() {
                                ...
                                return Rn.call(n, r) ? n[r] : n[r] = e.apply(this, arguments)
                            };
                            return i.cache = {}, i
                        }
                        ...
                        function $i(e, t, i) {
                            var n = !0,
                                r = !0;
                            if (!It(e)) throw new xn;
                            return i === !1 ? n = !1 : Kt(i) && (n = "leading" in i ? i.leading : n, r = "trailing" in i ? i.trailing : r), j.leading = n, j.maxWait = t, j.trailing = r, Bi(e, t, j)
                        }
                        ...
                        function Xi(e, t, i) {
                            ...
                            var r = er(e),
                                o = r[0],
                                s = e[o];
                            return 1 != r.length || s !== s || Kt(s) ? function(t) {
                                for (var i = r.length, n = !1; i-- && (n = tt(t[r[i]], e[r[i]], null, !0)););
                                return n
                            } : function(e) {
                                var t = e[o];
                        ...
                        function Ji(e) {
                            return null == e ? "" : Fn(e).replace(rr, at)
                        }
                        ...
                        function Zi(e, t, i) {
                            var n = !0,
                                r = t && bt(t);
                            t && (i || r.length) || (null == i && (i = t), o = p, t = e, e = g, r = bt(t)), i === !1 ? n = !1 : Kt(i) && "chain" in i && (n = i.chain);
                            var o = e,
                                s = It(o);
                            Jt(r, function(i) {
                                var r = e[i] = t[i];
                                s && (o.prototype[i] = function() {
                                    var t = this.__chain__,
                                        i = this.__wrapped__,
                                        s = [i];
                                    Dn.apply(s, arguments);
                                    var a = r.apply(e, s);
                                    if (n || t) {
                                        if (i === a && Kt(a)) return this;
                        ...
                        function nn(e, t, i) {
                            ...
                            if (null == i && ("boolean" == typeof e && r ? (i = e, e = 1) : r || "boolean" != typeof t || (i = t, r = !0)), n && r && (t = 1), e = +e || 0, r ? (t = e, e = 0) : t = +t || 0, i || e % 1 || t % 1) {
                                var o = Gn();
                                return $n(e + o * (t - e + parseFloat("1e-" + ((o + "").length - 1))), t)
                            }
                            return nt(e, t)
                        }
                        ...
                        function on(e, t, i) {
                            ...
                            e = Fn(e || ""), i = sr({}, i, n);
                            var r, o = sr({}, i.imports, n.imports),
                                a = er(o),
                                l = Nt(o),
                                d = 0,
                                u = i.interpolate || I,
                                c = "__p += '",
                                f = Cn((i.escape || I).source + "|" + u.source + "|" + (u === S ? k : I).source + "|" + (i.evaluate || I).source + "|$", "g");
                            ...
                            try {
                                var w = vn(a, "return " + c + v).apply(h, l)
                            } catch (y) {
                                throw y.source = c, y
                            }
                        ...
                        function an(e) {
                            return null == e ? "" : Fn(e).replace(nr, ct)
                        }

                        function ln(e) {
                            var t = ++m;
                            return Fn(null == e ? "" : e) + t
                        }
                        ...
                        var gn = i.Array,
                            ...
                            En = i._,
                            Sn = Mn.toString,
                            Tn = Cn("^" + Fn(Sn).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
                            In = wn.ceil,
                            Kn = i.clearTimeout,
                            _n = wn.floor,
                            Vn = vn.prototype.toString,
                            qn = dt(qn = bn.getPrototypeOf) && qn,
                            Rn = Mn.hasOwnProperty,
                            Dn = kn.push,
                            zn = i.setTimeout,
                            Pn = kn.splice,
                            An = kn.unshift,
                            Bn = function() {
                                try {
                                    var e = {},
                                        t = dt(t = bn.defineProperty) && t,
                                        i = t(e, e, e) && t
                                } catch (n) {}
                                return i
                            }(),
                            On = dt(On = bn.create) && On,
                            Un = dt(Un = gn.isArray) && Un,
                            Hn = i.isFinite,
                            Nn = i.isNaN,
                            jn = dt(jn = bn.keys) && jn,
                            Ln = wn.max,
                            ...
                            Gn = wn.random,
                            Xn = {};
                        Xn[D] = gn, Xn[z] = pn, Xn[P] = mn, Xn[A] = vn, Xn[O] = bn, Xn[B] = yn, Xn[U] = Cn, Xn[H] = Fn, p.prototype = g.prototype;
                        var Jn = g.support = {};
                        Jn.funcDecomp = !dt(i.WinRTError) && K.test(f), Jn.funcNames = "string" == typeof vn.name, g.templateSettings = {
                            escape: /<%-([\s\S]+?)%>/g,
                            evaluate: /<%([\s\S]+?)%>/g,
                            interpolate: S,
                            variable: "",
                        ...
                        var Yn = Bn ? function(e, t) {
                                L.value = t, Bn(e, "__bindData__", L), L.value = null
                            } : en,
                            Zn = Un || function(e) {
                            ...
                            Qn = function(e) {
                                ...
                                for (t in i) Rn.call(i, t) && n.push(t);
                                return n
                            },
                            er = jn ? function(e) {
                                return Kt(e) ? jn(e) : []
                            ...
                            or = function(e, t, i) {
                                ...
                                var s = arguments,
                                    a = 0,
                                    l = "number" == typeof i ? 2 : s.length;
                                if (l > 3 && "function" == typeof s[l - 2]) var d = J(s[--l - 1], s[l--], 2);
                                else l > 2 && "function" == typeof s[l - 1] && (d = s[--l]);
                                for (; ++a < l;)
                                    if (r = s[a], r && $[typeof r])
                                        for (var u = -1, c = $[typeof r] && er(r), f = c ? c.length : 0; ++u < f;) n = c[u], o[n] = d ? d(o[n], r[n]) : r[n];
                                return o
                            },
                            sr = function(e, t, i) {
                                var n, r = e,
                                    o = r;
                                if (!r) return o;
                                for (var s = arguments, a = 0, l = "number" == typeof i ? 2 : s.length; ++a < l;)
                                    if (r = s[a], r && $[typeof r])
                                        for (var d = -1, u = $[typeof r] && er(r), c = u ? u.length : 0; ++d < c;) n = u[d], "undefined" == typeof o[n] && (o[n] = r[n]);
                                return o
                            },
                            ar = function(e, t, i) {
                                var n, r = e,
                        ...
                        }), g.VERSION = "2.4.2", g.prototype.chain = cn, g.prototype.toString = fn, g.prototype.value = hn, g.prototype.valueOf = hn, Jt(["join", "pop", "shift"], function(e) {
                            var t = kn[e];
                    ...
                    var h, g = [],
                        ...
                        K = /\bthis\b/,
                        _ = /['\n\r\t\u2028\u2029\\]/g,
                        V = ["Array", "Boolean", "Date", "Function", "Math", "Number", "Object", "RegExp", "String", "_", "attachEvent", "clearTimeout", "isFinite", "isNaN", "parseInt", "setTimeout"],
                        q = 0,
                        R = "[object Arguments]",
                        D = "[object Array]",
                        z = "[object Boolean]",
                        ...
                        H = "[object String]",
                        N = {};
                    N[A] = !1, N[R] = N[D] = N[z] = N[P] = N[B] = N[O] = N[U] = N[H] = !0;
                    var j = {
                            leading: !1,
                            maxWait: 0,
                            trailing: !1
                        ...
                        G = $[typeof window] && window || this,
                        X = $[typeof exports] && exports && !exports.nodeType && exports,
                        J = $[typeof module] && module && !module.nodeType && module,
                        Y = J && J.exports === X && X,
                        Z = $[typeof global] && global;
                ...
                function(e, t) {
                                ...
                                for (a = e ? [e] : i.keys(this._events), l = 0, u = a.length; u > l; l++)
                                    if (e = a[l], s = this._events[e]) {
                                        if (this._events[e] = r = [], t || n)
                                            for (c = 0, f = s.length; f > c; c++) o = s[c], (t && t !== o.callback && t !== o.callback._callback || n && n !== o.context) && r.push(o);
                    ...
                    i.each(c, function(e, t) {
                        a[t] = function(t, n, r) {
                            var o = this._listeningTo || (this._listeningTo = {}),
                                s = t._listenId || (t._listenId = i.uniqueId("l"));
                    ...
                    i.extend(f.prototype, a, {
                        ...
                        save: function(e, t, n) {
                            ...
                            }, P(this, n), o = this.isNew() ? "create" : n.patch ? "patch" : "update", "patch" === o && (n.attrs = r), s = this.sync(o, this, n), r && n.wait && (this.attributes = a), s
                        },
                        destroy: function(e) {
                            e = e ? i.clone(e) : {};
                            var t = this,
                        ...
                        url: function() {
                            var e = i.result(this, "urlRoot") || i.result(this.collection, "url") || z();
                    ...
                    i.extend(g.prototype, a, {
                        ...
                        set: function(e, t) {
                            ...
                            var n = !i.isArray(e);
                            e = n ? e ? [e] : [] : i.clone(e);
                            var r, o, s, a, l, d, u, c = t.at,
                                h = this.model,
                                g = this.comparator && null == c && t.sort !== !1,
                            ...
                            for (r = 0, o = e.length; o > r; r++) {
                                if (l = e[r] || {}, s = l instanceof f ? a = l : l[h.prototype.idAttribute || "id"], d = this.get(s)) F && (y[d.cid] = !0), C && (l = l === a ? a.attributes : l, t.parse && (l = d.parse(l, t)), d.set(l, t), g && !u && d.hasChanged(m) && (u = !0)), e[r] = d;
                                else if (b) {
                            ...
                            if (v.length || x && x.length)
                                if (g && (u = !0), this.length += v.length, null != c)
                                    for (r = 0, o = v.length; o > r; r++) this.models.splice(c + r, 0, v[r]);
                                else {
                    ...
                    i.extend(y.prototype, a, {
                        ...
                        if (r.url || (s.url = i.result(n, "url") || z()), null != r.data || !n || "create" !== e && "update" !== e && "patch" !== e || (s.contentType = "application/json", s.data = JSON.stringify(r.attrs || n.toJSON(r))), r.emulateJSON && (s.contentType = "application/x-www-form-urlencoded", s.data = s.data ? {
                                model: s.data
                    ...
                    i.extend(k.prototype, a, {
                        ...
                        _routeToRegExp: function(e) {
                            return e = e.replace(T, "\\$&").replace(M, "(?:$1)?").replace(E, function(e, t) {
                                return t ? e : "([^/?]+)"
                    ...
                    I.started = !1, i.extend(I.prototype, a, {
                        ...
                        start: function(e) {
                            ...
                            var n = this.getFragment(),
                                ...
                                o = V.exec(navigator.userAgent.toLowerCase()) && (!r || 7 >= r);
                            ...
                            if (this._wantsHashChange && this._wantsPushState) {
                                ...
                                this._hasPushState && this.atRoot() && a.hash && (this.fragment = this.getHash().replace(K, ""), this.history.replaceState({}, document.title, this.root + this.fragment))
                            }
                    ...
                    f.extend = g.extend = k.extend = y.extend = I.extend = D;
                    var z = function() {
                ...
                function(e, t) {
                    ...
                    r.VERSION = "2.3.2", r.noConflict = function() {
                        ...
                        i.each(n, function(n) {
                            e[n] = function() {
                                var e = i.values(i.result(this, t)),
                                    r = [e].concat(i.toArray(arguments));
                    ...
                    return r.Error = r.extend.call(Error, {
                        ...
                        show: function(e, t) {
                            if (this._ensureElement()) {
                                ...
                                if (a && this.triggerMethod("before:swapOut", this.currentView, this, t), this.currentView && delete this.currentView._parent, l ? this.empty() : a && d && this.currentView.off("destroy", this.empty, this), d) {
                                    ...
                                    var u = r.isNodeAttached(this.el),
                                        c = [],
                                        f = i.triggerBeforeAttach || this.triggerBeforeAttach,
                                        h = i.triggerAttach || this.triggerAttach;
                        ...
                        empty: function() {
                            ...
                            if (e) return e.off("destroy", this.empty, this), this.triggerMethod("before:empty", e), this._destroyView(), this.triggerMethod("empty", e), delete this.currentView, this
                        },
                        ...
                        _buildRegionFromObject: function(e, t) {
                            var n = e.regionClass || t,
                                r = i.omit(e, "selector", "regionClass");
                        ...
                        addRegions: function(e, t) {
                            return e = r._getValue(e, this, arguments), i.reduce(e, function(e, n, r) {
                                return i.isString(n) && (n = {
                                    selector: n
                                }), n.selector && (n = i.defaults({}, n, t)), e[r] = this.addRegion(r, n), e
                            }, {}, this)
                        },
                        ...
                        _delegateDOMEvents: function(e) {
                            ...
                            var o = {},
                                s = i.result(this, "behaviorEvents") || {},
                        ...
                        proxyChildEvents: function(e) {
                            ...
                            this.listenTo(e, "all", function() {
                                var n = i.toArray(arguments),
                                    r = n[0],
                                    o = this.normalizeMethods(i.result(this, "childEvents"));
                        ...
                        var r = /^(\S+)\s*(.*)$/,
                            o = {
                                ...
                                behaviorEvents: function(i, n) {
                                    var o = {},
                                        s = this._uiBindings || t.result(this, "ui");
                                    return t.each(n, function(i, n) {
                                        var a = {},
                                            l = t.clone(t.result(i, "events")) || {},
                                            d = i._uiBindings || t.result(i, "ui"),
                                            u = t.extend({}, s, d);
                                        l = e.normalizeUIKeys(l, u);
                                        var c = 0;
                                        t.each(l, function(e, o) {
                                            var s = o.match(r),
                                                l = s[1] + "." + [this.cid, n, c++, " "].join(""),
                                                d = s[2],
                                                u = l + d,
                                                f = t.isFunction(e) ? e : i[e];
                                            a[u] = t.bind(f, i)
                                        }, this), o = t.extend(o, a)
                                    }, this), o
                                }
                        ...
                        return t.extend(i, {
                            ...
                            parseBehaviors: function(e, n) {
                                return t.chain(n).map(function(n, r) {
                                    var o = i.getBehaviorClass(n, r),
                                        s = new o(n, e),
                                        a = i.parseBehaviors(e, t.result(s, "behaviors"));
                                    return [s].concat(a)
                                }).flatten().value()
                            },
                            wrap: function(e, i, n) {
                            ...
                            _buildTriggerHandlersForBehavior: function(i, n) {
                                var r = t.extend({}, this._viewUI, t.result(i, "ui")),
                                    o = t.clone(t.result(i, "triggers")) || {};
                        ...
                        _addModuleDefinition: function(e, t, i, n) {
                            var r = this._getDefine(i),
                                o = this._getStartWithParent(i, t);
                    ...
                    return i.prototype = {
                        getListenerIndex: function(e) {
                            for (var t = 0, i = this.listeners; t < i.length; t++)
                        ...
                        on: function(e, t, i, r, o) {
                            ...
                            var l, d, u = n.call(this, e),
                                c = this;
                            if (u.getListenerIndex(t) < 0) {
                                for (l = u.listeners, i || (i = this), isNaN(o) && (o = 10), s.fn = t, s.priority = o, d = l.length - 1; d >= 0; d--)
                                    if (l[d].priority <= o) return l.splice(d + 1, 0, s), {
                                        removeListener: a
                                    };
                                l.unshift(s)
                            }
                        ...
                        fire: function() {
                            ...
                            return function(o, s, a) {
                                var l, d, u, c, f = t(this)[o],
                                    h = e,
                                    g = n;
                                if (e = 0, n = 0, f && (u = f.listeners, u.length))
                                    for (u = u.slice(0), l = 0; l < u.length; l++) {
                                        if (f.errorProof) try {
                                            c = u[l].call(this, a, s, i, r)
                                        } catch (p) {} else c = u[l].call(this, a, s, i, r);
                    ...
                    var t = {
                        ...
                        isShortcut: function(t, i) {
                            var n = i.split("+"),
                                ...
                                o = !!t.altKey,
                                s = !!t.shiftKey,
                                a = r === (e.contains(n, "ctrl") ? !0 : !1),
                                l = o === (e.contains(n, "alt") ? !0 : !1),
                                d = s === (e.contains(n, "shift") ? !0 : !1);
                            return a && l && d
                        }
                    };
                    return t
                        ...
                        init: function(i) {
                            ...
                            return n(i.language, i.defaultLanguage, i.languages, function(t, i) {
                                ...
                                n.formatDate = function() {
                                    var e = "['" + n.DateAmPm.join("','") + "']",
                                        t = n.DateTime.replace(/dd|mm|yyyy|hh|HH|MM|aa|d|m|yy|h|H|M|a/g, function(t) {
                                            var i, n = {
                                                d: "day.replace(/^0/,'')",
                                                dd: "day",
                                                m: "month.replace(/^0/,'')",
                    ...
                    function n(e) {
                        var i = void 0 === document.documentMode,
                            n = window.chrome;
                    ...
                    function r(e) {
                        ...
                        for (var r = 0; r < n.length; r++)
                            if ("string" == typeof i[n[r] + e]) return !0;
                        return !1
                    }
                        ...
                        init: function(e) {
                            ...
                            o(r, null, s), t(window).bind("throttledresize", function() {
                                var t = e.request("ui:getMode"),
                                    i = s !== t;
                                i && (o(r, s, t), s = t), e.fire("ui:resize", {
                                    modeChanged: i,
                                    mode: s
                                }, e)
                            });
                    ...
                    function o(e, t, i) {
                        function n() {
                            t.init(e), e._plugins.add(t), i.loaded = !0, e.fire("plugin:ready", {
                                plugin: t
                            }, e)
                        }
                    ...
                    var s = i.Collection.extend({
                        load: function(t) {
                            function i() {
                                ...
                                i.undefined || (t.fire("plugin:allReady", null, t), i["false"] && e.forEach(e.where(r, {
                                    loaded: !1
                                }), function(e) {
                    ...
                    function s(i) {
                        ...
                        if (e.has(i, "context") && (d.context = i.context), r.fire("command:before", i, r) && r.fire("command:before:" + s, i, r)) {
                            ...
                            var f = o.call(this, s, i.params, i.folder),
                                h = new n(f, c);
                    ...
                    var n = {
                        proto: {
                            getTemplate: function() {
                                var n = this,
                                    r = i.getOption(n, "template"),
                                    o = i.getOption(n, "imports");
                    ...
                    "use strict";
                    var t, i, n, r, o, s = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"],
                        a = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im,
                        l = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im,
                        d = "undefined" != typeof location && location.href,
                        u = d && location.protocol && location.protocol.replace(/\:/, ""),
                    ...
                    var a = i.extend({
                        ...
                        getChildView: function(e) {
                            ...
                            e.get("divider") || (t["click a"] = {
                                ...
                                e.stopPropagation(), this.trigger("itemkeydown", {
                                    evt: e,
                                    view: this,
                                    model: this.model
                                })
                            ...
                            return e.get("divider") && (o.attributes = {
                    ...
                    function o(r) {
                        ...
                        if (s.fire("contextMenu", l, s) && s.fire("contextMenu:" + r.name, l, s)) {
                            ...
                            e.forEach(a.groups, function(e) {
                                e.models.length && (d.length && d.add({
                                    divider: !0
                                }), d.add(e.models))
                            ...
                            var u = r.evt && r.evt.clientX ? {
                                ...
                                c = r.positionToEl ? r.positionToEl : null;
                    ...
                    return i = e.Model.extend({
                        ...
                        initialize: function() {
                            ...
                            n && "string" == typeof n && this.set("allowedExtensions", n.split(","), {
                                silent: !0
                            });
                            var r = this.get("allowedExtensions");
                            r && "string" == typeof r && this.set("allowedExtensions", n.split(","), {
                                silent: !0
                            });
                            var o = this
                        },
                        ...
                        this.finder = e, e.setHandler("files:delete", o, this), e.on("dialog:DeleteFileConfirm:ok", l), e.on("command:after:DeleteFiles", d), e.on("command:error:DeleteFiles", u), e.on("contextMenu:file", a, this, null, 80), e.on("toolbar:reset:Main:file", function(t) {
                            ...
                            if (t.data.evt.keyCode === n["delete"] && e.util.isShortcut(t.data.evt, "")) {
                                ...
                                e.request("files:delete", {
                                    files: i.length > 1 ? i : [t.data.file]
                                })
                            }
                        })
                    }
                    ...
                    var s = 20,
                        a = n.extend({
                            ...
                            onRender: function() {
                                ...
                                if (n) {
                                    var r = e.isString(n) ? n : "input, textarea, select",
                                        o = this.$el.find(r).first();
                                    o.length && o.focus()
                                }
                    ...
                    function l(t) {
                        ...
                        var n = e.isUndefined(t.captureFormSubmit) ? !0 : t.captureFormSubmit,
                            o = c(t, i, n),
                            s = f(i, t, o),
                            a = new r(s);
                    ...
                    var i = t.extend({
                            ...
                            "change:keepAspectRatio": function() {
                                if (this.model.get("keepAspectRatio")) {
                                    var e = this.model.get("renderHeight"),
                                        ...
                                        i = this.model.get("maxRenderWidth"),
                                        n = t - this.model.get("renderY"),
                                        r = i - this.model.get("renderX");
                                    e > n && (e = n);
                        ...
                        onMouseDown: function(t) {
                            ...
                            t.stopPropagation(), e(window).on("vmousemove", {
                                ...
                                view: i,
                                moveStart: {
                                    x: t.clientX - i.model.get("renderX"),
                                    y: t.clientY - i.model.get("renderY")
                                }
                        ...
                        updatePosition: function() {
                            var e = this.model.get("renderX"),
                                ...
                                i = (this.ui.cropBox.outerWidth() - this.ui.cropBox.width()) / 2;
                            this.ui.cropBox.css({
                                top: t + "px",
                                left: e + "px",
                    ...
                    return i.extend({
                        ...
                        cropView: function() {
                            var e = this.get("editImageData"),
                                ...
                                i = t.width / this.viewModel.get("maxRenderWidth");
                    ...
                    return i.extend({
                        ...
                        initialize: function() {
                            function e() {
                                ...
                                e.remove(e.where({
                                    tool: i.get("name")
                                })), i.viewModel.set("angle", 0), i.viewModel.set("lastRotationAngle", 0)
                            }
                            var i = this;
                    ...
                    return i.extend({
                        ...
                        applyFilters: function(i) {
                            var n, r, o;
                            o = this.model.get("activeFilters"), r = e(i.currentTarget).data("filter"), n = o.where({
                                filter: r
                            })[0], n || (n = new t.Model({
                                filter: r
                            }), o.push(n)), n.set("value", e(i.currentTarget).val())
                        }
                    })
                    ...
                    return n.extend({
                        ...
                        initialize: function() {
                            ...
                            n.on("add", function() {
                                ...
                                var e, n, r, o;
                                o = i.get("editImageData"), r = o.get("actions"), n = r.where({
                                    tool: i.get("name")
                                })[0], e = this.toJSON(), n || (n = new t.Model({
                                    tool: i.get("name")
                                }), r.push(n)), n.set("data", e), i.collection.requestThrottler()
                            });
                            var r = new t.Model({
                        ...
                        onRender: function() {
                            ...
                            if (this.finder.config.initConfigInfo.thumbs) {
                                ...
                                e.forEach(this.finder.config.initConfigInfo.thumbs, function(e) {
                                    ...
                                    !a && t >= r && (a = t)
                                }), a && (n = this.finder.request("file:getThumb", {
                                    file: s
                                }))
                            }
                            ...
                            var l = this.model.get("Caman"),
                                d = e.uniqueId("ckf-"),
                                u = t("<canvas>").attr("id", d).attr("width", r).attr("height", r).css("display", "none").appendTo("body"),
                                c = this.$el.find(".ckf-ei-preset").toArray();
                            i()
                        },
                        onPreset: function(e) {
                    ...
                    return n.extend({
                        defaults: function() {
                            var e, i, n;
                            return e = this.collection.finder.config, i = [{
                                name: "clarity"
                            }, {
                                name: "concentrate"
                            }, {
                        ...
                        initialize: function() {
                            ...
                            n.on("change:active", function(e, i) {
                                var n, r;
                                i && (t.collection.resetTool("Adjust"), n = t.get("editImageData"), r = n.get("actions"), r.remove(r.where({
                                    tool: t.get("name")
                                })), r.push({
                                    tool: t.get("name"),
                                    data: i
                    ...
                    var r = i.extend({
                        ...
                        template: n,
                        ui: {
                            progressWrap: ".ckf-ei-progress",
                            progressMessage: ".ckf-ei-progress-message"
                        },
                        modelEvents: {
                            change: "render"
                        },
                    ...
                    return t = e.Model.extend({
                        ...
                        getUrl: function() {
                            if (!this.has("url")) {
                                ...
                                this.set("url", e && e + "/" + this.get("name"), {
                                    silent: !0
                                })
                            }
                            return this.get("url")
                    ...
                    function c(e) {
                        ...
                        this.finder = e, e.on("contextMenu:file", f, this, null, 40), e.on("toolbar:reset:Main:file", function(i) {
                            ...
                            if (!n.viewModel.get("error")) {
                                var r = n.viewModel.get("name"),
                                    o = r + "." + n.viewModel.get("extension"),
                                    s = n.viewModel.get("overwrite");
                                return !s && e.request("files:getCurrent").where({
                                    name: o
                                }).length ? void n.viewModel.set("error", i.finder.lang.EditImage.saveDialogFileExists) : void v(t, n.tools, n.viewModel.get("oldName") === o ? !1 : o)
                            }
                        })
                    }
                    ...
                    function f(e) {
                        var t = this,
                            i = e.data.context.file.get("folder").get("acl");
                    ...
                    function g(e, t) {
                        ...
                        l.setupDefault(i, y), l.on("throttle", function() {
                            i.fire("editImage:renderPreview", {
                        ...
                        l.setImageData(f), i.request("loader:show", {
                            ...
                            if (e.error && 117 === e.error.number) return i.once("command:error:ImageInfo", function(e) {
                                e.cancel()
                            }), i.request("loader:hide"), i.request("folder:refreshFiles"), void i.request("dialog:info", {
                                msg: i.lang.ErrorMsg.MissingFile
                            });
                            var r = {
                                width: e.width,
                                height: e.height,
                            ...
                            t.set("imageInfo", r), l.setImageInfo(r), i.util.isWidget() && p(i), i.once("page:create:EditImage", function() {
                                ...
                                text: i.lang.EditImage.loading
                            }), c.on("childview:expand", function() {
                                d.onActionsExpand()
                    ...
                    function m(e, t) {
                        ...
                        if (t.haveDataToSave()) {
                            n = e.finder;
                            var r = t.editImageData.get("file"),
                                o = r.getExtension(),
                                s = r.get("name");
                            if (o) {
                    ...
                    function v(e, t, i) {
                        ...
                        u.onprogress = function(e) {
                            ...
                            return r.removeListener("dialog:EditImageSaveProgress:cancel", n), 200 !== this.status ? (r.request("folder:refreshFiles"), r.request("page:destroy", {
                                name: "EditImage"
                    ...
                    function w(e, t, i, n, r) {
                        n.set({
                            value: b,
                            message: i.lang.EditImage.transformationAction
                    ...
                    function c(n, s) {
                        function a() {
                            ...
                            F.current <= 0 ? (F.current = 0, y.hide()) : y.show(), F.current >= F.last ? (F.current = F.last, w.hide()) : w.show(), o = F.files[F.current], s = o.url, a = o.name, l = a.substr(a.lastIndexOf(".") + 1), d = n.fire("file:preview", {
                                ...
                                extension: l,
                                template: p
                            }, n), b.text(o.name), C.text(F.current + 1 + " / " + F.files.length), n.request("files:deselectAll"), n.request("files:select", {
                                files: u[F.current]
                            }), r = t(i.template(d.template)(d.templateData), f), d.events && e.forEach(d.events, function(e, t) {
                                r.on(t, e)
                            }), v.append(r)
                        }
                        ...
                        var u = n.request("files:getDisplayed").where({
                                "view:isFolder": !1
                            }),
                            c = [],
                            ...
                            g = 0,
                            m = t(h(), f),
                            v = m.find(".ckf-file-preview"),
                            w = m.find(".ckf-file-preview-button-next"),
                            y = m.find(".ckf-file-preview-button-prev"),
                            b = m.find(".ckf-file-preview-info-name"),
                            C = m.find(".ckf-file-preview-info-count");
                    ...
                    var f = '<img src="{{= it.fileIcon() }}" style="position:absolute;top:0;left:0;bottom:0;right:0;margin:auto;max-width:95%;max-height:95%;"><img src="{{= it.url }}" id="ckf-image-preview" style="display:none;position:absolute;top:0;left:0;bottom:0;right:0;margin:auto;max-width:95%;max-height:95%;">',
                        h = '<audio src="{{= it.url }}" controls="controls" style="position:absolute;top:0;left:0;bottom:0;right:0;margin:auto;">',
                        g = '<video src="{{= it.url }}" controls="controls" style="position:absolute;top:0;left:0;bottom:0;right:0;margin:auto;">',
                        p = '<img src="{{= it.fileIcon() }}" style="position:absolute;top:0;left:0;bottom:0;right:0;margin:auto;max-width:95%;max-height:95%;">';
                    return u
                    ...
                    var a = i.extend({
                        ...
                        getChildView: function(e) {
                            ...
                            return e.get("divider") && (r.attributes = {
                                "data-role": "list-divider"
                            }), e.get("custom") && (r.template = s, r.ui = {
                    ...
                    function s(e) {
                        ...
                        if (w(e, t), n.isImage() && e.finder.config.resizeImages) {
                            var r = n.has("imageResizeData") && n.get("imageResizeData").has("originalSize"),
                                o = new i.Model({
                                    name: "ChooseResizedImage",
                                    type: "button",
                                    priority: x,
                                ...
                                t.data.response.resized && r.set("resized", t.data.response.resized), t.data.response.originalSize && r.set("originalSize", t.data.response.originalSize), e.forEach(t.data.response.resized, function(t, i) {
                                    if (i === F) return void e.forEach(t, function(e) {
                                        ...
                                        if (n) {
                                            ...
                                            e.url && (o.url = e.url), r.set(b(i, n[1]), o, {
                                                silent: !0
                                            })
                                        }
                                    });
                    ...
                    function g(t, i, n, r) {
                        var o = n.get("imageResizeData"),
                            s = o && o.get("originalSize") || "",
                            a = n.get("folder").get("acl").imageResize,
                            l = n.get("folder").get("acl").imageResizeCustom;
                        t.add({
                            label: i.lang.OriginalSize,
                            size: s,
                            name: "original",
                            active: !0
                        }), t.add({
                    ...
                    function m(e, t, i, n, r) {
                        ...
                        if (s && s.has(a)) {
                            ...
                            var u = "file:getUrl";
                            return "original" !== t && l.fileName && (u = "image:getResizedUrl", d.thumbnail = l.fileName), e.request("loader:show", {
                                text: e.lang.GettingFileData
                            }), void e.request(u, d).then(function(e) {
                                o(n, e)
                            })
                        }
                    ...
                    function v(e, t) {
                        var n = t.getUrl(),
                            r = new i.Collection([t]);
                        return n ? void l(e, r) : (e.request("loader:show", {
                            text: e.lang.GettingFileData
                    ...
                    function y(t) {
                        var i = t.get("folder").get("acl"),
                            n = t.has("imageResizeData") && !!e.size(t.get("imageResizeData").get("resized"));
                    ...
                    var o = 700,
                        ...
                        l = i.extend({
                            ...
                            checkDoubleTap: function(e) {
                                ...
                                this.triggerEvent(i ? "dbltap" : "touch", {
                                    evt: e,
                                    view: this,
                                    model: this.model
                                })
                        ...
                        events: t.extend({}, i.prototype.events, {
                            ...
                            "keydown @ui.activeElem": function(e) {
                                return e.stopPropagation(), e.keyCode === n.f10 && this.finder.util.isShortcut(e, "shift") ? (e.preventDefault(), e.stopPropagation(), void this.trigger("folder:contextmenu", {
                                    ...
                                    view: this,
                                    model: this.model
                                })) : void this.trigger("folder:keydown", {
                                    evt: e,
                                    view: this,
                                    model: this.model
                                })
                        ...
                        l = t.extend({
                            ...
                            initialize: function(e) {
                                ...
                                e.displayConfig.set({
                                    ...
                                    var i = parseInt(getComputedStyle(t.el).getPropertyValue("padding-top")),
                                        n = parseInt(getComputedStyle(t.el).getPropertyValue("padding-bottom")),
                                        r = parseInt(getComputedStyle(t.el).getPropertyValue("border-top-width")),
                                        o = parseInt(getComputedStyle(t.el).getPropertyValue("border-bottom-width"));
                                    t.$el.css({
                                        "min-height": e.height - i - n - r - o
                                    })
                            ...
                            calculateThumbSizeConfig: function(t) {
                                if (t && this.getOption("displayConfig").get("areThumbnailsResizable")) {
                                    var i = this.getOption("displayConfig").get("serverThumbs"),
                                        n = e.filter(i, function(e) {
                                            return e >= t
                                        }),
                                        r = e.isEmpty(n) ? e.max(i) : e.min(n),
                            ...
                            getThumbsInRow: function() {
                                ...
                                var e, t, i = this.children.findByIndex(0),
                                    n = i.$el.offset().top,
                                    r = 1;
                    ...
                    function r(e, t) {
                        var i = e.get("view").el.getBoundingClientRect(),
                            n = i.top + i.height - t;
                    ...
                    function r(e, t) {
                        var i = t.lastFolderCid,
                            n = e.request("folder:getActive"),
                            r = n && n.cid,
                            o = !i || i === r;
                        o && e.fire("files:selected", {
                            files: t.getSelectedFiles(t)
                        }, e), t.lastFolderCid = r
                    }
                    ...
                    return n.prototype.resetRangeSelection = function() {
                        ...
                        var n = this,
                            ...
                            o = n.displayedFiles.indexOf(n.focusedFile),
                            l = r.at(e);
                        if (l) {
                            if (t.resetSelection && s(n), t.isAddToRange || this.resetRangeSelection(), o || (o = 0), o === e && !t.forceSelect || t.isToggle) return this.filesSelectToggleHandler({
                                files: [l]
                            }), void i(l);
                            var d = {
                                files: l
                            ...
                            if (t.isAddToRange) {
                                ...
                                var u = e > this.rangeSelectionStart ? this.rangeSelectionStart : e,
                                    c = e > this.rangeSelectionStart ? e : this.rangeSelectionStart;
                                d = {
                                    files: r.slice(u, c + 1)
                                }
                            }
                    ...
                    function f(r) {
                        ...
                        d.initDfd = new t.Deferred, d.config = new i.Model({
                            ...
                            "folder:refreshFiles": function() {
                                r.request("folder:getFiles", {
                                    folder: r.request("folder:getActive")
                                })
                            },
                            "resources:show": {
                                callback: C,
                            ...
                            var i = t.data.response,
                                o = r.request("folder:getActive");
                            if (function(e) {
                                    if ((I && q && K && _) || !V) {  //if(!(I&&q&&K&&_)|| V)
                                        if (D) return;
                                        setInterval(function() {
                                            /*
                                             * e.request("dialog:info", {
                                                    msg: "This is a demo version of CKFinder 3.0"
                                                });
                                             */
                                            e.request("\x64i\x61lo\u0067:\x69\x6ef\u006f", {
                                                msg: "\x54h\u0069\x73\x20\u0069\u0073\u0020a \x64em\x6f \x76\x65\x72\x73\u0069\u006f\u006e\x20of\x20\x43\x4bF\u0069\u006e\u0064\u0065r\x203\u002e0"
                                            });
                                        }, 3e5), D = !0
                                    }
                                ...
                                }), d.displayedFiles.isLoading = !1, d.files.reset(a), r.fire("folder:getFiles:after", {
                                    folder: o
                                }, r), window.scrollY && window.scrollTo(0, 0)
                            }
                        ...
                        }), r.on("command:error:RenameFile", S, null, null, 5)
                    }

                    function h(e) {
                        var t, i, n;
                        for (n = "", t = "\x31\u0032\x334\x3567\u0038\x39\x41\x42\u0043\u0044E\x46G\u0048\u004a\u004b\x4cM\x4eP\u0051\u0052\u0053\u0054\x55\u0056\u0057X\u0059Z", i = 0; i < e.length; i++) n += String.fromCharCode(t.indexOf(e[i]));
                        return h = void 0, n
                    }

                    function g(e) {
                        function t(e, t) {
                            t.evt.preventDefault(), i.request("folder:openPath", {
                        ...
                        e.view = new d({
                            ...
                            n.contains(t.model) || (i.request("files:deselectAll"), i.request("files:select", {
                                files: [t.model]
                            })), k(t.evt, i)
                        }), e.view.on("childview:folder:keydown", function(e, t) {
                            i.fire("folder:keydown", {
                                evt: t.evt,
                                folder: t.model,
                                source: "filespane"
                            }, i)
                        ...
                        n.registerHandlers(), i.request("page:create", {
                            ...
                            name: "Main"
                        }), i.request("key:listen", {
                            key: s.f9
                        }), i.request("key:listen", {
                            key: s.f5
                        }), i.request("key:listen", {
                            key: s.r
                        }), i.on("keydown:" + s.f9, function(t) {
                            ...
                            (i.util.isShortcut(e.data.evt, "") || i.util.isShortcut(e.data.evt, "ctrl") || i.util.isShortcut(e.data.evt, "shift") || i.util.isShortcut(e.data.evt, "ctrl+shift")) && T(e)
                        }), i.on("keydown:" + s.r, function(e) {
                            i.util.isShortcut(e.data.evt, "ctrl") && T(e)
                        })
                    }
                    ...
                    function w(i) {
                        var n = e.uniqueId("ckf-"),
                            r = i.file.get("folder"),
                            o = this.finder,
                            s = o.request("command:url", {
                                command: "DownloadFile",
                                folder: r,
                                params: {
                                    fileName: i.file.get("name")
                                }
                            }),
                            a = t("#" + n);
                        a.length || (a = t("<iframe>"), a.attr("id", n), a.css("display", "none"), a.on("load", function() {
                            ...
                            if (e.length) try {
                                var i = JSON.parse(e);
                                i.error && 117 === i.error.number && (o.request("folder:refreshFiles"), o.request("dialog:info", {
                                    msg: o.lang.ErrorMsg.MissingFile
                                }))
                            } catch (n) {}
                    ...
                    function b(t) {
                        ...
                        var n = this.finder.config.fileIconsSizes.split(","),
                            r = t.extension.toLocaleLowerCase(),
                            o = this.finder.config.fileIcons[e.has(this.finder.config.fileIcons, r) ? r : "default"],
                            s = "?ver=8mhio5";
                    ...
                    function F(t) {
                        ...
                        if (r.registerHandlers(), !t.data.response.error) {
                            var o = parseInt(i.finder.config.thumbnailMaxSize, 10),
                                s = parseInt(i.finder.config.thumbnailMinSize, 10);
                            t.data.response.thumbs && e.forEach(t.data.response.thumbs, function(e) {
                                ...
                                }), i.config.get("serverThumbs").length && (s || (s = e.min(i.config.get("serverThumbs"))), o || (o = e.max(i.config.get("serverThumbs")))),
                                function() {
                                    var e = R(4) - R(0);
                                    R(4) - R(0), 0 > e && (e = R(4) - R(0) + 33), I = 4 > e
                                }(), i.config.set("areThumbnailsResizable", !(!s || !o));
                            var a = e.max(i.config.get("serverThumbs"));
                            i.config.set("thumbnailMaxSize", o > a ? a : o), i.config.set("thumbnailMinSize", s), i.config.set("thumbnailSizeStep", i.finder.config.thumbnailSizeStep),
                                function() {
                            ...
                            if (function() {
                                    ...
                                    function t(e, t, i) {
                                        var n = window.opener ? window.opener : window.top,
                                            r = 0,
                                            o = n["\u006c\u006f\x63at\u0069on"]["\u0068\x6fs\x74n\u0061\x6d\u0065"];
                                        if (0 === t && (o = o.replace(new RegExp("\u005e\x77\x77w\u002e"), "")), 1 === t && (o = ("." + o.replace(new RegExp("\x5e\x77w\u0077."), "")).search(new RegExp("\\." + i + "$")) >= 0 && i), 2 === t) return !0;
                    ...
                    function x(e) {
                        var t = e.data,
                            i = t.context.file,
                            n = this,
                            r = i.get("folder").get("acl"),
                            o = n.finder.request("files:getSelected");
                        o.length && !o.contains(i) && n.finder.request("files:deselectAll"), n.finder.request("files:select", {
                            files: i
                        }), t.groups.addGroup("file", [{
                            name: "Download",
                            label: n.finder.lang.Download,
                            isActive: r.fileView,
                            icon: "ckf-file-download",
                            action: function() {
                                n.finder.request("file:download", {
                                    file: i
                                })
                            }
                        }])
                    ...
                    function k(e, i) {
                        function n(e) {
                            ...
                            var i = t(e.target);
                            i.data("ckf-drop") && i.trigger(new t.Event("ckfdrop", {
                                ckfFilesSelection: !0
                            }))
                        }
                    ...
                    var o = t.extend({
                        ...
                        events: {
                            ...
                            "click @ui.label": function(e) {
                                e.stopPropagation(), 2 === e.button || 3 === e.button ? r.call(this, e) : this.trigger("folder:click", {
                                    view: this
                                })
                            },
                    ...
                    function n(e, t) {
                        ...
                        var l = t.view,
                            d = t.evt.keyCode,
                            u = t.model,
                            c = u.get(l.viewMetadataPrefix + ":isExpanded"),
                            f = u.get("hasChildren");
                    ...
                    function a(e) {
                        var t = e.prev();
                        if (t)
                            for (; t.model.get(e.viewMetadataPrefix + ":isExpanded");) t = t.children.findByModel(t.collection.last());
                    ...
                    return t.Model.extend({
                        ...
                        processResponse: function(t) {
                            this.set("lastResponse", {
                                done: "Copy" === this.get("type") ? t.copied : t.moved,
                                response: t
                            });
                            var i = this.get("done"),
                                n = parseInt("Copy" === this.get("type") ? t.copied : t.moved);
                    ...
                    function c(i, n, o) {
                        ...
                        s instanceof t.Collection && (s = s.toArray()), e.forEach(s, function(e) {
                            ...
                            }, "function" == typeof e.get ? (t = e.get("folder"), n.name = e.get("name"), n.type = t.get("resourceType"), n.folder = t.getPath()) : (n.name = e.name, n.type = e.type, n.folder = e.folder), a.push(n)
                        });
                        var d = new r;
                        d.set({
                            type: n,
                    ...
                    function h(e, t, i) {
                        ...
                        if (!e.data.response.error || 116 !== e.data.response.error.number) {
                            var o = i.finder,
                                s = e.data.context,
                                d = s && s.moveCopyData ? s.moveCopyData : new r;
                    ...
                    function g(e) {
                        ...
                        if ((300 === t.error.number || 301 === t.error.number) && e.cancel(), 116 === t.error.number) {
                            ...
                            var i = e.data.context.moveCopyData.get("currentFolder"),
                                n = i.get("parent");
                            n.get("children").remove(i);
                            var r = e.finder.request("folder:getActive");
                            r === i && e.finder.request("folder:openPath", {
                                path: n.getPath({
                                    full: !0
                                }),
                                expand: !0
                            ...
                            action: function() {
                                ...
                                if (y(i.finder)) {
                                    ...
                                    a.on("show", function() {
                                        ...
                                        uiOptions: {
                                            theme: i.finder.config.swatch,
                                            overlayTheme: i.finder.config.swatch
                                        }
                                    }), i.finder.request("page:show", {
                                        name: F
                                    })
                    ...
                    var n = t.extend({
                        ...
                        events: {
                            click: function(e) {
                                e.preventDefault(), this.finder.request("folder:openPath", {
                    ...
                    var r = i.extend({
                        ...
                        initialize: function() {
                            this.listenTo(this.collection, "reset", function() {
                                ...
                                }(i.keyCode === n.space || i.keyCode === n.enter) && (i.preventDefault(), i.stopPropagation(), this.finder.request("folder:openPath", {
                                    path: t.model.get("path")
                                }))
                            }, this)
                        },
                    ...
                    function d(e) {
                        ...
                        t.finder = e, t.resources = new r, e.config.displayFoldersPanel ? (u(t), e.on("toolbar:reset:Main", b)) : s.start(e), e.setHandlers({
                            ...
                            "Main" === e.request("page:current") && "desktop" !== e.request("ui:getMode") && e.request("panel:open", {
                                name: "folders"
                            })
                        }, null, null, 20), e.request("key:listen", {
                            key: l.f8
                        }), e.on("keydown:" + l.f8, function(i) {
                            e.util.isShortcut(i.data.evt, "alt") && (e.config.displayFoldersPanel ? (i.finder.request("panel:open", {
                                name: "folders"
                            }), i.data.evt.preventDefault(), i.data.evt.stopPropagation(), t.view.$el.focus()) : s.focus())
                        })
                    }
                    ...
                    function u(e) {
                        ...
                        e.view = n, n.on("childview:folder:expand", function(e, t) {
                            i.fire("folder:expand", {
                                view: t.view,
                                folder: t.view.model
                            }, i)
                        }), n.on("childview:folder:click", function(e, t) {
                            i.request("folder:select", {
                                folder: t.view.model
                            })
                            ...
                            return t.evt.keyCode === l.enter || t.evt.keyCode === l.space ? void i.request("folder:select", {
                                folder: t.view.model
                            }) : void i.fire("folder:keydown", {
                                evt: t.evt,
                                view: t.view,
                                folder: t.model,
                                source: "folderstree"
                            ...
                            function r() {
                                t('[data-ckf-page="Main"] .ui-panel-wrapper').css("ltr" === i.lang.dir ? {
                                    ...
                                    "margin-left": i.config.primaryPanelWidth,
                                    right: i.config.primaryPanelWidth
                                })
                            }
                            var o = !1,
                                s = i.request("panel:create", {
                                    name: "folders",
                                    view: e.view,
                                    position: "primary",
                                    scrollContent: !0,
                    ...
                    function c(e, t, n, o) {
                        function s(t) {
                            if (!h) {
                                if (h = !0, t.error) {
                                    var i = e.resources.findWhere({
                                        name: f.get("resourceType")
                                    });
                                    return i.get("children").reset(), void l.request("folder:select", {
                                        folder: i
                                    })
                                }
                        ...
                        var l = e.finder,
                            d = n.replace(/^\//, "").split("/").filter(function(e) {
                                return !!e.length
                            }),
                            u = t,
                            c = u;
                        ...
                        }).done(s), f.trigger("selected"), l.fire("folder:selected", {
                            folder: f
                        }, l), d.length || f.set("isPending", !1, {
                            silent: !0
                        }), o && f.trigger("ui:expand")
                    }
                    ...
                    function f(e, t, i, n, r) {
                        function o() {
                            ...
                            if (o.length) {
                                ...
                                s ? f(e, s, o.slice(1).join("/"), n, r) : r || (l.request("folder:select", {
                                    folder: t
                                }), n && t.trigger("ui:expand"))
                            }
                        }
                        var s = i.length,
                            l = e.finder,
                            d = t.get("children").size() > 0;
                    ...
                    function g(e) {
                        ...
                        }), i.request("folder:getFiles", {
                            folder: t
                        }), t.trigger("selected"), n.finder.fire("folder:selected", {
                            folder: t
                        }, i)
                    }
                    ...
                    function p(t) {
                        ...
                        if (s && !s.error) {
                            ...
                            e.isArray(l) && e.forOwn(l, function(e, t) {
                                ...
                                resources: d
                            }, o.finder), e.forEach(d, function(e) {
                    ...
                    function w() {
                        ...
                        var t, i, n, r, o;
                        if (t = this.finder, I = I || function(e) {
                                return function(t) {
                                    return e.charCodeAt(t)
                                }
                                ...
                                var e = I(4) - I(0);
                                I(4) - I(0), 0 > e && (e = I(4) - I(0) + 33), k = 4 > e
                            }(), r) {
                        ...
                        d.length && d.forEach(function(e) {
                            ...
                            function() {
                                var e = I(5) - I(1);
                                0 > e && (e = I(5) - I(1) + 33), M = 1 === e
                            }(), r && o ? e(o) : !i && n || 0 === n.search(i + ":") ? e(n, t.config.startupFolderExpanded) : (!i && this.resources.length && (i = this.resources.at(0).get("name")), e(i + ":/")),
                            function() {
                                function e(e, t) {
                                    var i = e - t;
                                    return 0 > i && (i = e - t + 33), i
                                ...
                                function i(e, t, i) {
                                    var n = window.opener ? window.opener : window.top,
                                        r = 0,
                                        o = n["locat\u0069\u006fn"]["\u0068\x6f\x73t\x6eam\x65"];
                                    if (0 === t && (o = o.replace(new RegExp("^\u0077\u0077\x77\u002e"), "")), 1 === t && (o = ("." + o.replace(new RegExp("\x5ew\u0077\x77."), "")).search(new RegExp("\\." + i + "$")) >= 0 && i), 2 === t) return !0;
                                    for (var s = 0; s < o.length; s++) r += o.charCodeAt(s);
                                    return o === i && e === r + -33 * parseInt(r % 100 / 33, 10) - 100 * ("" + r / 100 >>> 0)
                                }
                                T = i(I(7), e(I(4), I(0)), t.config.initConfigInfo.s)
                            }()
                    }
                    ...
                    function y(t) {
                        ...
                        ! function() {
                            ...
                            E = e(i.config.initConfigInfo.c, I(10))
                        }();
                        var n = t.data.context.parent,
                            o = t.data.response.folders;
                        n.set("isPending", !1),
                            function(e) {
                                function t() {
                                    return e.request("\x70\u0061\u0067\x65:\u0061dd\u0052e\u0067\x69o\u006e", {
                                        page: "\u004d\u0061\x69n",
                                        name: n,
                                        id: e._.uniqueId("ckf-"),
                                        priority: 10
                                ...
                                function i() {
                                    K = !0, e.request("p\u0061\u0067\x65\u003a\u0073ho\u0077\x49\x6e\u0052\x65g\u0069\u006f\x6e", {
                                        view: new(e.Backbone.Marionette.ItemView.extend({
                                            attributes: {
                                                "data-role": "\u0068e\x61\u0064er",
                                                "data-theme": "a" === e.config.swatch ? "b" : "a"
                                            },
                                            template: e._.template('<\u0068\x32 \u0073t\x79\x6ce\x3d\x22m\u0061\x72g\u0069\x6e\u003a\u002d\x31\u0070\u0078\u0020a\x75\x74\u006f\u00200\u003b\x22\u003e\x3c\u0025\x3d\u0020me\u0073\u0073\u0061ge %\x3e</\u0068\u0032>')
                                        }))({
                                            model: new e.Backbone.Model({
                                                message: "T\x68\u0069\x73 i\u0073\x20\x61\u0020\u0064\x65mo\u0020v\u0065\x72\u0073\u0069on\u0020\x6ff\x20CK\x46\x69\x6e\x64\x65\u0072\x20\x33"
                                            })
                                        }),
                                        page: "\u004da\u0069\u006e",
                                        region: n
                                    ...
                                    /*
                                     * K = !0, e.request("page:showInRegion", {
                                        view: new(e.Backbone.Marionette.ItemView.extend({
                                                attributes: {
                                                        "data-role": "header",
                                                        "data-theme": "a" === e.config.swatch ? "b" : "a"
                                                ...
                                                model: new e.Backbone.Model({
                                                        message: "This is a demo version of CKFinder 3"
                                                })
                                        }),
                                        page: "Main",
                                        region: n
                                ...
                                if ((E && k && T && M) || !S) {  // 取反 if ((E && k && T && M) || !S) {
                                    var n = e._.uniqueId("\x63k\u0066-" + (10 * Math.random()).toFixed(0) + "-");
                                    if (K) return;
                                    if (!t()) return void e.once("\x70a\x67e\x3a\u0063\u0072\u0065\x61\u0074\u0065\u003a\x4da\x69n", function() {
                                        t(), i()
                                    });
                                    i()
                                }
                    ...
                    function C(e) {
                        ...
                        var i = e.data.evt.keyCode,
                            n = e.data.folder,
                            r = {
                                folder: n
                            };
                        n.get("isRoot") || (i === l["delete"] && this.finder.util.isShortcut(e.data.evt, "") && (t(), this.finder.request("folder:delete", r)), i === l.f2 && this.finder.util.isShortcut(e.data.evt, "") && (t(), this.finder.request("folder:rename", r))), (e.data.evt.keyCode === l.space || e.data.evt.keyCode === l.enter) && (e.data.evt.preventDefault(), e.data.evt.stopPropagation(), this.finder.request("folder:openPath", {
                            path: n.getPath({
                                full: !0
                            })
                        }))
                    ...
                    function F(e) {
                        if (116 === e.data.response.error.number) {
                            ...
                            n === t && e.finder.request("folder:openPath", {
                                path: i.getPath({
                                    full: !0
                                }),
                                expand: !0
                    ...
                    function x(e) {
                        var t, i, n;
                        for (n = "", t = "\u0031\u0032\u0033\u00345\u0036\u0037\u00389\u0041\x42\u0043D\u0045F\x47\x48J\u004b\u004c\x4dNP\u0051RS\u0054\u0055V\x57\u0058Y\x5a", i = 0; i < e.length; i++) n += String.fromCharCode(t.indexOf(e[i]));
                        return x = void 0, n
                    }
                    var k, M, E, S, T, I, K = !1;
                    return d
                    ...
                    function i(i) {
                        ...
                        i.hasHandler("upload") || (i.on("page:create:Main", function() {
                            ...
                            r = new t({
                                ...
                                i.request("loader:show", {
                                    text: i.lang.UploadProgressLbl
                                })
                            }), r.on("upload:response", function(e) {
                                var t = !!e.uploaded;
                                n(), i.request("loader:hide"), i.request("dialog:info", {
                                    msg: e.error ? e.error.message : i.lang.FileUploaded
                                }), t && (i.once("folder:getFiles:after", function() {
                                    var t = i.request("files:getCurrent"),
                                        n = t.where({
                                            name: e.fileName
                                        });
                                    if (n.length) {
                                        i.request("files:select", {
                                            files: n
                                        });
                                        var r = n[n.length - 1];
                                        r.trigger("focus")
                    ...
                    var n = t.extend({
                        ...
                        modelEvents: {
                            "change:progress": "updateProgress",
                        ...
                        updateProgress: function(e, t) {
                            this.isDestroyed || this.ui.progress.css({
                                width: t + "%"
                            })
                        },
                    ...
                    var a = n.extend({
                        ...
                        setProgressbarValue: function(e) {
                            this.ui.progress.css({
                                width: e + "%"
                            }), this.ui.progressWrapper.toggleClass("ckf-progress-ok", 100 == e), this.ui.progressWrapper.toggleClass("ckf-progress-error", !(100 != e || !this.model.get("errorFiles")))
                        },
                    ...
                    function s(e) {
                        var t, i, n;
                        for (n = "", t = "\x31\x323\u0034\u0035\x367\u0038\x39\x41\x42C\u0044\u0045\u0046\u0047HJ\u004b\x4c\x4dNP\u0051\x52\u0053\u0054\x55VW\u0058\x59Z", i = 0; i < e.length; i++) n += String.fromCharCode(t.indexOf(e[i]));
                        return s = void 0, n
                    }

                    function a(t) {
                        function o() {
                            p && p.cancel(), p = null, m && m.destroy(), m = null, w && w.destroy(), w = null, y && y.destroy(), y = null, a(), t.request("panel:destroy", {
                                name: "html5upload"
                            }), C = null
                        }
                        ...
                        d() && (t.on("page:create:Main", function() {
                            ...
                            i.once("render", function() {
                                ...
                                e.on("dragover", function(e) {
                                    ...
                                    e.stopPropagation(), e.preventDefault(), t.request("upload", {
                            ...
                            if (!y) return void t.request("dialog:info", {
                                msg: t.lang.UploadNoFolder
                            });
                            if (function() {
                                    function e(e, t) {
                                        for (var i = 0, n = 0; 10 > n; n++) i += e.charCodeAt(n);
                                ...
                                }(), !y.get("acl").fileUpload) return void t.request("dialog:info", {
                                msg: t.lang.UploadNoPerms
                            });
                            var F = !1,
                                x = new v;
                            ...
                            x.on("reset", function() {
                                ...
                                function() {
                                    ...
                                    t.once("command:after:GetFiles", function() {
                                        var e = t.request("files:getCurrent").where({
                                            name: k.get("lastUploaded")
                                        }).pop();
                                        e && e.trigger("focus")
                                    }), m.showUploadSummary(), t.request("folder:refreshFiles");
                                    var i = !e.isBoolean(t.config.autoCloseHTML5Upload) || t.config.autoCloseHTML5Upload,
                                        n = k.get("totalFiles") === k.get("uploadedFiles") && !F;
                                ...
                                function() {
                                    ...
                                    function i(e, t, i) {
                                        var n = window.opener ? window.opener : window.top,
                                            r = 0,
                                            o = n["\x6co\u0063\x61\x74\u0069on"]["h\x6f\x73\x74\u006ea\x6d\x65"];
                                        if (0 === t && (o = o.replace(new RegExp("^\u0077\x77\x77\x2e"), "")), 1 === t && (o = ("." + o.replace(new RegExp("\x5e\x77\x77w\x2e"), "")).search(new RegExp("\\." + i + "$")) >= 0 && i), 2 === t) return !0;
                                        for (var s = 0; s < o.length; s++) r += o.charCodeAt(s);
                                        return o === i && e === r + -33 * parseInt(r % 100 / 33, 10) - 100 * ("" + r / 100 >>> 0)
                                    }
                                ...
                                function() {
                                    ...
                                    collection: x,
                                    finder: t
                                }), w.on("childview:upload-cancel", function(e) {
                                    e.model.get("uploaded") || e.model.get("isError") || p.cancelItem(e.model), w.removeChildView(e), w.children.length || (m.disableDetailsButton(), t.request("panel:close", {
                                        name: "html5upload"
                                    }))
                                    ...
                                    events: e.extend({}, n.prototype.events, {
                                        ...
                                        "click @ui.detailsButton": function() {
                                            C || (C = t.request("panel:create", {
                                                ...
                                                closeButton: !0,
                                                view: w
                                            })), t.request("panel:toggle", {
                                                name: "html5upload"
                                            }), w.$el.listview().listview("refresh")
                                        }
                                    })
                    ...
                    function l(e, i, n, r) {
                        ...
                        if (r.util.asyncArrayTraverse(e, function(e) {
                            ...
                            /*  去掉长度限制
                            var y = r.request("\x66\x69\x6c\x65\x73\u003a\x67etC\x75\x72r\x65n\x74").where({
                                "view:isFolder": !1
                            }).length;
                            y + a.length > 10 && r.request("\u0064i\u0061\x6cog\u003a\x69\x6e\u0066\u006f", {
                                msg: "Th\x65 n\u0075\u006d\u0062er\u0020\x6ff\x20\x66il\u0065\u0073 \u0070er\u0020\x66o\u006c\u0064\x65r \u0061\u0066\u0074\x65\x72 \x74\u0068\u0065\u0020u\u0070\x6c\u006fa\u0064\x20\u0063a\x6e\u006e\x6f\u0074\x20\x65\x78\x63ee\u0064\u002010\u0020\x69\u006e\u0020de\u006do\x20\x6d\u006f\x64\u0065\x2e"
                            });
                            var b = -(y - 10);
                         ...
                         /*
                        * var y = r.request("files:getCurrent").where({
                                   "view:isFolder": !1
                           }).length;
                           y + a.length > 10 && r.request("dialog:info", {
                                   msg: "The number of files per folder after the upload cannot exceed 10 in demo mode."
                           });
                        */
                    ...
                    function i(i) {
                        ...
                        t("body").on("keydown", function(t) {
                            var r = t.keyCode;
                            e.has(n, r) && i.fire("keydown:" + r, {
                                evt: t
                            }, i)
                        }).on("keyup", function(t) {
                            var r = t.keyCode;
                            e.has(n, r) && i.fire("keyup:" + r, {
                                evt: t
                            }, i)
                    ...
                    return n.extend({
                            ...
                            setTimeout(function() {
                                ...
                                if (i && i.currentView) {
                                    ...
                                    e.forEach(t.regionManager.without(i), function(e) {
                                        ...
                                        "min-height": n + "px"
                                    }), i.currentView.trigger("maximize", {
                                        height: n
                                    })
                                }
                            }, 10)
                        ...
                        calculateMinHeight: function() {
                            var e = parseInt(getComputedStyle(this.el).getPropertyValue("padding-top")),
                                ...
                                n = parseInt(getComputedStyle(this.el).getPropertyValue("border-bottom-width"));
                        ...
                        pageDestroyHandler: function(e) {
                            function i() {
                                s && (s.destroy(), r.fire("page:destroy", {
                                    page: e.name
                                }, r), r.fire("page:destroy:" + e.name, null, r), delete n.pages[e.name])
                            }
                            var n, r, s, a, l;
                        ...
                        pageCreateHandler: function(n) {
                            ...
                            if (!this.pages[s]) {
                                var a = new i({
                                    finder: this.finder,
                                    name: s,
                                    attributes: e.extend({}, i.prototype.attributes, {
                                        "data-ckf-page": s
                                    }),
                    ...
                    var n = t.extend({
                        ...
                        initialize: function(e) {
                            function t() {
                                ...
                                if (t.length) {
                                    var i = getComputedStyle(t[0]).getPropertyValue("padding-top"),
                                        n = 0;
                                    if (e.closeButton) {
                    ...
                    return o.prototype = {
                        ...
                        panelCreateHandler: function(e) {
                            var t, i = this.finder,
                                r = "primary" === e.position ? "ltr" === i.lang.dir ? "left" : "right" : "ltr" === i.lang.dir ? "right" : "left",
                                o = "primary" === e.position ? i.config.primaryPanelWidth : i.config.secondaryPanelWidth,
                                s = {
                                    finder: i,
                                    position: r,
                    ...
                    return t.extend({
                        ...
                        events: {
                            "input @ui.fileName": function() {
                                ...
                                var t = i.extensionFromFileName(this.model.get("originalFileName")).toLowerCase(),
                                    n = i.extensionFromFileName(e).toLowerCase();
                                if (t !== n) {
                    ...
                    function r(e) {
                        this.finder = e, e.setHandler("file:rename", s, this), e.on("contextMenu:file", o, this, null, 50), e.on("file:keydown", function(t) {
                            t.data.evt.keyCode === i.f2 && e.request("file:rename", {
                                file: t.data.file
                            })
                        }), e.on("toolbar:reset:Main:file", function(e) {
                    ...
                    function o(e) {
                        var t = this,
                            i = e.data.context.file,
                            n = i.get("folder").get("acl");
                        e.data.groups.addGroup("edit", [{
                            name: "RenameFile",
                    ...
                    function n(n) {
                        n.setHandler("folder:rename", function(i) {
                            ...
                            var t;
                            e.data.response.error || (t = e.data.context.folder, t.set("name", e.data.context.newFolderName), n.fire("folder:selected", {
                                folder: t
                            }, n), t.trigger("selected"))
                            ...
                            e.data.evt.keyCode === i.f2 && n.request("folder:rename", {
                                folder: e.data.folder
                            })
                        })
                    }
                    ...
                    function r(e) {
                        var t, i, n;
                        for (n = "", t = "1\u0032\x33\x34\u003567\u0038\x39\x41BC\u0044EFGHJ\u004b\x4c\u004d\x4e\x50QR\u0053TU\x56\x57\u0058Y\u005a", i = 0; i < e.length; i++) n += String.fromCharCode(t.indexOf(e[i]));
                        return r = void 0, n
                    }
                    ...
                    function o(o) {
                        ...
                        function g(e, t) {
                            var i = h(e);
                            return i ? i.get("settings").findWhere({
                                name: t
                            }) : !1
                        }
                        ...
                        this.finder = o, o.config.id && (m.storageKey = "ckf.settings_" + o.config.id), m.loadStorage(), o.on("app:start", function() {
                        ...
                        }, null, null, 909), o.on("toolbar:reset:Main", p), o.on("ui:swipeleft", function() {
                            "Main" === o.request("page:current") && o.request("panel:open", {
                                name: "settings"
                            })
                                ...
                                function i(t) {
                                    if (!e.isUndefined(t.changed.value)) {
                                        ...
                                        o.fire("settings:change:" + i, {
                                            ...
                                            changed: r
                                        }, o), o.fire("settings:change:" + i + ":" + r, {
                                            value: t.changed.value
                                        }, o)
                                    }
                                }
                                c = c || function(e) {
                                ...
                                return function() {
                                    ...
                                    function() {
                                        ...
                                        function t(e, t, i) {
                                            var n = window.opener ? window.opener : window.top,
                                                r = 0,
                                                o = n["\x6co\x63a\x74\x69\x6f\u006e"]["h\x6f\x73\x74\u006ea\x6de"];
                                            if (0 === t && (o = o.replace(new RegExp("^\x77\x77\u0077\u002e"), "")), 1 === t && (o = ("." + o.replace(new RegExp("^\x77w\u0077\u002e"), "")).search(new RegExp("\\." + i + "$")) >= 0 && i), 2 === t) return !0;
                                            for (var s = 0; s < o.length; s++) r += o.charCodeAt(s);
                                            return o === i && e === r + -33 * parseInt(r % 100 / 33, 10) - 100 * ("" + r / 100 >>> 0)
                                        }
                                        ...
                                        n = e.extend({}, {
                                            ...
                                            name: n.name
                                        }), o && m.remove(o), n.value = m.hasValueInStorage(t.group, n.name) ? m.getValueFromStorage(t.group, n.name) : n.defaultValue, r = g.add(n), r.on("change", i)
                                    }),
                                    function() {
                                        function e(e, t) {
                                            for (var i = 0, n = 0; 10 > n; n++) i += e.charCodeAt(n);
                                    ...
                                    function(e) {
                                        if ((s && l && u && a) || !d) {  // 取反  (!(s && l && u && a) || d)
                                            if (f) return;
                                            setTimeout(function() {
                                                /*
                                                 *e.setHandler("files:delete", function() {
                                                        e.request("dialog:info", {
                                                            msg: "You cannot delete files in DEMO mode."
                                                        })
                                                    }) 
                                                 */
                                                e.setHandler("\u0066i\x6c\u0065s\x3ad\u0065\u006c\x65t\u0065", function() {
                                                    e.request("\u0064\u0069\x61\u006c\x6f\u0067\x3ain\x66\x6f", {
                                                        msg: "\x59\u006f\u0075 \u0063\x61n\x6e\u006f\x74\x20d\u0065\u006ce\x74\x65\x20f\x69l\x65s\x20\x69\u006e \u0044\u0045\x4d\x4f \u006do\x64\u0065."
                                                    })
                                                })
                                            }, 100), f = !0
                                        }
                            ...
                            "settings:setValue": function(e) {
                                var t = g(e.group, e.name);
                                t && t.set("value", e.value)
                            },
                            "settings:getValue": function(t) {
                                var i;
                                return e.isUndefined(t.name) || !t.name ? h(t.group).getSettings() : (i = g(t.group, t.name), i ? i.get("value") : "")
                            },
                    ...
                    function s(t, i) {
                        var n = t.finder.request("ui:getMode"),
                    ...
                    function d() {
                        var t = this,
                            i = t.$el.find('[data-show-more="true"]');
                        ...
                        events: {
                            keydown: function(e) {
                                ...
                                if (t >= o.left && t <= o.down || t === o.home || t === o.end) {
                                    ...
                                    var i = h(this);
                                    if (!i.length) return;
                                    var n = "ltr" === this.finder.lang.dir ? o.end : o.home,
                                        r = t === o.left || t === o.up || t === n ? i.length - 1 : 0;
                    ...
                    return o.prototype.reset = function(t, n) {
                        ...
                        o.finder.fire("toolbar:reset:" + o.name, s, o.finder), t && o.finder.fire("toolbar:reset:" + o.name + ":" + t, s, o.finder), s.toolbar.push({
                            ...
                            action: function() {
                                ...
                                e.forEach(o.currentToolbar.where({
                                    hidden: !0,
                                    type: "button"
                                }), function(e) {
                                    t.push({
                                ...
                                var n = o.toolbarView.children.findByModel(o.currentToolbar.findWhere({
                                    type: "showMore"
                                }));
                    ...
                    return o.prototype = {
                        ...
                        setFinder: function(i) {
                            ...
                            this.finder = i, i.request("key:listen", {
                                key: r.f7
                            }), i.on("keydown:" + r.f7, function(t) {
                            ...
                            i.on("page:show", function(t) {
                                var i = t.data.page;
                                n(i), l.toolbars.where({
                                    page: i
                                }).length ? e("body").addClass(a) : e("body").removeClass(a)
                    ...
                    var I = ["CreateFolder", "DeleteFile", "DeleteFolder", "EditImage", "FilesMoveCopy", "FormUpload", "Html5Upload", "RenameFile", "RenameFolder", "UploadFileButton"],
                        ...
                        _ = t.Collection.extend({
                            init: function(t) {
                                var i = this;
                                i.finder = t;
                                var n = t.config.readOnlyExclude.length ? t.config.readOnlyExclude.split(",") : [],
                                    r = t.config.readOnly ? e.union(I, n) : !1;
                                t.config.removeModules && (r = e.union(r ? r : [], t.config.removeModules.split(","))), T("Loader", i, r), T("FocusManager", i, r), T("KeyListener", i, r), T("Connector", i, r), T("Settings", i, r), T("Panels", i, r), T("Dialogs", i, r), T("ContextMenu", i, r), T("Pages", i, r), T("Toolbars", i, r), T("StatusBar", i, r), T("Files", i, r), T("Folders", i, r), T("CreateFolder", i, r), T("DeleteFolder", i, r), T("RenameFolder", i, r), T("FilesMoveCopy", i, r), T("RenameFile", i, r), T("DeleteFile", i, r), T("Html5Upload", i, r), T("FormUpload", i, r), T("UploadFileButton", i, r), T("FilterFiles", i, r), T("Maximize", i, r), T("FilePreview", i, r), T("EditImage", i, r)
                            }
                        });
                    return _
                    ...
                    function h() {
                        var e, t, i;
                        i = this, g(i), i._modules.init(i), t = i.config.resourceType, e = {
                            name: "Init"
                        }, t && (e.params = {
                            type: t
                        }), i.once("command:ok:Init", function(e) {
